...
export const endpoints = {
  ...
  ingredientController: {
    ...
    deleteProductById: (): EndpointProps => "/api/ingredients/delete-ingredient",
  ...
  waiterController: {
    fetchWaitersForAdminPage: (): EndpointProps => "/api/waiters/fetch-waiters-for-admin-page",
    fetchWaitersForWaiterPage: (): EndpointProps => "/api/waiters/fetch-waiters-for-waiter-page",
  ...
  servingTableController: {
    fetchServingTables: (): EndpointProps => "/api/serving-tables/fetch-serving-tables",

    fetchServingTableById: (): EndpointProps => "/api/serving-tables/fetch-serving-table-by-id",

    deleteServingTableById: (): EndpointProps => "/api/serving-tables/delete-serving-table",

    updateServingTable: (): EndpointProps => "/api/serving-tables/update-serving-table",

    closeServingTableById: (): EndpointProps => "/api/serving-tables/close-serving-table",

    createNewTableAndFirstOrder: (): EndpointProps => "/api/serving-tables/create-serving-table-with-first-order",

    saveNewOrderToExistingTable: (): EndpointProps => "/api/serving-tables/update-serving-table-with-new-order",

    payTablePrice: (): EndpointProps => "/api/serving-tables/pay-serving-table-price",
  },

  /** Contains URLs that are part of backend API for customer orders, created by certain waiter */
  orderController: {
    deleteOrderProductFromOrder: (): EndpointProps => "/api/orders/delete-product-from-order",

    deleteOrderFromServingTable: (): EndpointProps => "/api/orders/delete-order-from-serving-table",
  },

  /** Contains URLs that are part of backend API for kitchen order */
  kitchenOrdersController: {
    fetchUncompletedKitchenOrders: (): EndpointProps => "/api/kitchen-orders/fetch-uncompleted-kitchen-orders",

    fetchCompletedKitchenOrtders: (): EndpointProps => "/api/kitchen-orders/fetch-completed-kitchen-orders",

    markKitchenOrderAsCompleted: (): EndpointProps => "/api/kitchen-orders/mark-order-as-completed",
  },
};
