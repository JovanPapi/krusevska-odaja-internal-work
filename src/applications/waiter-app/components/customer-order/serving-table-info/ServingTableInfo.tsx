...
const ServingTableInfo = () => {
  ...
  const { selectedServingTable, selectedServingTableOrder } =
      ...
      <table className="servingTableInfo-table-of-products">
        <thead>
          <tr>
            ...
            <th>
              {intl.formatMessage({
                id: "servingTableInfo.text.th.order",
        ...
        <tbody>
              ...
              <tr key={stp.uuid}>
                ...
                <td>
                  {stp.product?.listOfIngredients.map((ing, index) => {
                    if (
                      index ===
                      (stp.product?.listOfIngredients.length as number) - 1
                    ) {
                      return ing.name;
                    }
                    return ing.name + ", ";
                ...
                <td>
                  {intl.formatMessage({
                    id: "servingTableInfo.text.td.oldOrder",
                  })}
                </td>
              </tr>
            ))
          ...
          {selectedServingTableOrder?.listOfOrderProducts?.map((stp, index) => (
            <tr key={index}>
              ...
              <td>
                {intl.formatMessage({
                  id: "servingTableInfo.text.td.newOrder",
                })}
              </td>
            </tr>
          ))}
